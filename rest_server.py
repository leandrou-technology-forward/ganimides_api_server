...
from _serverApp import log_process_message,retrieve_module_configuration
from _serverApp import confirm_token
from _serverApp import Fore
...
module_version = 0.1
module_function = "restapi_server"
...
def not_found_404(error):
    ...
    # error_code = 404
    # result="error"
    # retugitrn render_template('verification_result_page.html', message=message, secondary_message=secondary_message, result=result, error_code=error_code)
    # return render_template('404.html', message=message, secondary_message=secondary_message, result=result, error_code=error_code)
##########################################################################################################################
##########################################################################################################################
##########################################################################################################################
...
#::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
#::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
# print(thisApp.application_configuration['modules'])
# print('')
# print(thisApp.application_configuration['modules_loaded'])
ix=0
for k in thisApp.application_configuration['modules_loaded'].keys():
    ix=ix+1
    mid = k
    mfolder = thisApp.application_configuration['modules_loaded'].get(k)
    #print(ix, mid, mfolder)
    print(ix, mid)
    
# x=thisApp.get_module_debug_level2('bankServices_BOC_api')
# exit(0)
