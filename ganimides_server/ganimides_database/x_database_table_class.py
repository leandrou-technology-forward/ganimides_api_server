...
from _serverApp import _appEnvironment as thisApp
from _serverApp._logServices import log_message
...
class leandroutechnologyforward_database_table_class:
 ...
 #   color = thisApp.Fore.LIGHTBLUE_EX
    ...
    #-----------------------------------#
    def __init__(self, schema_dictionary, db_session, table_model, table_alias, table_entity):
        ...
        schema_dictionary.update({table_alias:self})
    #::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    #::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    #::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    ...
    def convert_model_to_dict(self, show=None, _hide=[]):
        ...
        return record_dict
    ########################################################################################
    def row_to_dict(self, row, method=''):
        if not row:
            return {}
        row_dict={}
        if hasattr(self.model, "_hidden_fields"):
    ...
    def rows_to_dict(self, rows, method=''):
        rows_array=[]
        for row in rows:
            rows_array.append(self.row_to_dict(row, method))
        return rows_array
    ########################################################################################
    ...
    #     self.current_record_dict = self.row_to_dict(self.current_record_obj)
    ...
    #     #     self.records_dict.append(self.row_to_dict(row, method=''))
    #     return self.current_record_dict
    # ########################################################################################
...
#     #::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    ...
    def get_one_row_as_dict(self, access_key):
        ...
        if not rowObj:
            return {}
        current_record_dict = self.row_to_dict(rowObj)
...
#     #::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    def check_table(self):
        ...
        if self.physical_table_is_synchronized:
            ...
            msg = msg + f" columns"
        if thisApp.get_module_debug_level(module_id) or debug:
