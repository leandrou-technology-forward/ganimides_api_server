...
from _serverApp import print_message,print_api_result,log_message,colorized_message
from _database_ganimides_engine import db_self, db_table_action
self = db_self.self
...
#::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
#::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
def dbapi_device(self, action, input_dict, filter_dict={}, caller_dict={}):
    ...
    return api_result
#::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
def dbapi_device_log(self, device_uid, application_name, geolocation_lat, geolocation_lon, client_id):
    #https://www.pythoncentral.io/series/python-sqlalchemy-database-tutorial/
    ...
    return api_result
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
def dbapi_device_logV3(self, device_uid, application_name, geolocation_lat, geolocation_lon, client_id):
    #https://www.pythoncentral.io/series/python-sqlalchemy-database-tutorial/
    #https://www.pythoncentral.io/understanding-python-sqlalchemy-self/
    ...
    #client=self.query(CLIENT).filter(CLIENT.client_id==client_id).one()
    application = self.query(APPLICATION).filter(APPLICATION.application_name == application_name).one()
    application_id = application.application_id
    try:
        device = self.query(DEVICE).filter(DEVICE.device_uid == device_uid).one()
    except:
        device=None
    if not device:
    ...
    try:
        deviceusage = self.query(DEVICE_USAGE).filter(DEVICE_USAGE.device_uid == device_uid, application_name == application_name, geolocation_lat == geolocation_lat, geolocation_lon == geolocation_lon, client_id == client_id).one()
    except:
        deviceusage = None
    if not deviceusage:
    ...
    try:
        clientdevice = self.query(CLIENT_DEVICE).filter(CLIENT_DEVICE.device_uid == device_uid, application_id == application_id, client_id == client_id).one()
    except:
        clientdevice = None
    if not clientdevice:
    ...
    return api_result
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
def dbapi_device_register_unregister(self, input_dict, action='Register'):
    ...
    if input_dict.get('applications', '').upper() in ('*', 'ALL') \
        ...
        client_devices = self.query(CLIENT_DEVICE).filter(CLIENT_DEVICE.device_uid == device.device_uid, CLIENT_DEVICE.client_id == client_id, CLIENT_DEVICE.status != status).all()
        if len(client_devices) <= 0:
            client_devices = self.query(CLIENT_DEVICE).filter(CLIENT_DEVICE.device_uid == device.device_uid, CLIENT_DEVICE.client_id == client_id).all()
            client_device_records = db_self.rows_to_dict(CLIENT_DEVICE, client_devices)
    ...
    return api_result
#::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
def dbapi_device_usage(self, action, input_dict, filter_dict={}, caller_dict={}):
    ...
    return api_result
#::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
def dbapi_client_device(self, action, input_dict, filter_dict={}, caller_dict={}):
    ...
    return api_result
#::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
def dbapi_api(self, action, input_dict, filter_dict={}, caller_dict={}):
    _api_name = "dbapi_api"
    _api_entity = 'API'
    _api_action = action
    debug = False
    ...
    return api_result    
#::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
def dbapi_api_register(self, input_dict):
    ...
    return api_result
#::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
def dbapi_api_unregister(self, input_dict):
    ...
    return api_result
#::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
def dbapi_application_api(self, action, input_dict, filter_dict={}, caller_dict={}):
    ...
    return api_result
#::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
def dbapi_application(self, action, input_dict, filter_dict={}, caller_dict={}):
    ...
    return api_result
#::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
def dbapi_application_credentials_are_valid(self, application_name, client_id, client_secretKey):
    debug = False
    application=dbschema.APPLICATIONS_TABLE.get({'application_name': application_name})
    if not application:
        return False    
    ...
    return True
#::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
def dbapi_token(self, action, input_dict, filter_dict={}, caller_dict={}):
    ...
    return api_result
#::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
def dbapi_token_is_valid(self, token):
    debug = False
    if type(token) == type(''):
    ...
    return True
#::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
def dbapi_token_get_access_token(self, token_request):
    debug = False
...
def dbapi_cleanup_tokens(self):
    ...
    return api_result
#::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
def dbapi_bank(self, action, input_dict, filter_dict={}, caller_dict={}):
    ...
    return api_result
#::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
def dbapi_client(self, action, input_dict, filter_dict={}, caller_dict={}):
    ...
    return api_result
#::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
def dbapi_service_provider(self, action, input_dict, filter_dict={}, caller_dict={}):
    ...
    return api_result
#::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
def dbapi_user(self, action, input_dict, filter_dict={}, caller_dict={}):
    ...
    return api_result
#::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
def dbapi_consumer(self, action, input_dict, filter_dict={}, caller_dict={}):
    ...
    return api_result
#::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
def dbapi_merchant(self, action, input_dict, filter_dict={}, caller_dict={}):
    ...
    return api_result
#::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
def dbapi_merchant_pointofsale(self, action, input_dict, filter_dict={}, caller_dict={}):
    ...
    return api_result
#::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
def dbapi_merchant_employee(self, action, input_dict, filter_dict={}, caller_dict={}):
    ...
    return api_result
#::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
def dbapi_interaction(self, action, input_dict, filter_dict={}, caller_dict={}):
    ...
    return api_result
#::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
def dbapi_interaction_message(self, action, input_dict, filter_dict={}, caller_dict={}):
    ...
    return api_result
#::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
def dbapi_bank_authorization(self, action, input_dict, filter_dict={}, caller_dict={}):
    ...
    return api_result
#::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
def dbapi_bank_subscription(self, action, input_dict, filter_dict={}, caller_dict={}):
    ...
    return api_result
#::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
def dbapi_bank_account(self, action, input_dict, filter_dict={}, caller_dict={}):
...
#::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
# #::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
def xdbapi_client_confirm(self, input_dict):
...
#     return {'api_status':'success','api_message':msg,'api_data':client}
# #::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
def dbapi_client_banksubscription_register(self, bank_subscription_record, user='?', device_uid=None, geolocation_lat=None, geolocation_lon=None):
    debug = False
...
#     return {'api_status':'success','api_message':msg,'api_data':merchant}
# #::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
def dbapi_merchant_get_bankaccounts(self, merchant_record, user='?', device_uid=None, geolocation_lat=None, geolocation_lon=None):
    debug = False
    ...
    return accounts
#::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
def dbapi_merchant_bankaccount_register(self, bankaccount_record, user='?', device_uid=None, geolocation_lat=None, geolocation_lon=None):
    debug = False
...
#     return {'api_status':'success','api_message':msg,'api_data':pointofsale}
#::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
def dbapi_pointofsale_bankaccount_add(self, bankaccount_record, user='?', device_uid=None, geolocation_lat=None, geolocation_lon=None):
    debug = False
...
#::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
def dbapi_pointofsale_bankaccount_remove(self, pointofsale_record, user='?', device_uid=None, geolocation_lat=None, geolocation_lon=None):
    debug = False
...
#     return {'api_status':'success','api_message':msg,'api_data':employee}
# #::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
def dbapi_pointofsale_credit_info(self, pointofsale_record, user='?', device_uid=None, geolocation_lat=None, geolocation_lon=None):
    debug = False
...
#     return result
#::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
def dbapi_consumer_banksubscription_register(self, bank_subscription_record, user='?', device_uid=None, geolocation_lat=None, geolocation_lon=None):
    debug = False
...
#::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
#::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
def dbapi_interaction_start(self, interaction_record, user='?', device_uid=None, geolocation_lat=None, geolocation_lon=None):
    debug = False
    ...
    return result
#::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
def dbapi_interaction_finish(self, interaction_record, user='?', device_uid=None, geolocation_lat=None, geolocation_lon=None):
    debug = False
    ...
    return result
#::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
def dbapi_interaction_message_add(self, interaction_record, user='?', device_uid=None, geolocation_lat=None, geolocation_lon=None):
    debug = False
...
#     return result
# #::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
def dbapi_bank_subscription_register(self, bank_subscription_record, user='?', device_uid=None, geolocation_lat=None, geolocation_lon=None):
    debug = False
...
#::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
def dbapi_bank_account_register(self, bank_account_record, user='?', device_uid=None, geolocation_lat=None, geolocation_lon=None):
    debug = False
...
#::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
def dbapi_cleanup_bank_authorizations(self):
...
#::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
#::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
#master_configuration = retrieve_module_configuration(__file__, module_identityDictionary, master_configuration, print_enabled=thisApp.CONSOLE_ON, filelog_enabled=thisApp.FILELOG_ON, handle_as_init=True)
#::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
#::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
#::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
