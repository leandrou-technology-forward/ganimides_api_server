...
import sys
#4 levels up
if not (os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(__file__)))) in sys.path): sys.path.append(os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(__file__)))))
...
from _serverApp import set_debug_ON,set_debug_OFF,set_debug_level
from _serverApp import log_message, log_result_message, log_module_initialization_message
from _serverApp import retrieve_module_configuration
from _serverApp import log_message_subprocess_running,log_message_wait,log_message_wait_success,log_message_special_error,log_message_special_success
from _serverApp._utilities import find_file
...
module_color = thisApp.Fore.LIGHTGREEN_EX
...
#::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
################################################################
def boc_create_authorize_and_commit_subscription(access_token, allow_transactionHistory=True, allow_balance=True, allow_details=True, allow_checkFundsAvailability=True, payments_limit=0, payments_currency='EUR', payments_amount=0):
    ...
    authorization_code = boc_get_customer_authorization(subscriptionId)
    ...
    commit_result = boc_commit_subscription(subscriptionId, authorization_token, access_token,current_subscription_data)
    ...
    return create_result
################################################################
def boc_create_subscription(access_token, allow_transactionHistory=True, allow_balance=True, allow_details=True, allow_checkFundsAvailability=True, payments_limit=0, payments_currency='EUR', payments_amount=0):
    ...
    #create subscription record
    xcreate_result = boc_get_subscriptionId(access_token, allow_transactionHistory=allow_transactionHistory, allow_balance=allow_balance, allow_details=allow_details, allow_checkFundsAvailability=allow_checkFundsAvailability, payments_limit=payments_limit, payments_currency=payments_currency, payments_amount=payments_amount)   
    ...
    return create_result
################################################################
def boc_authorize_and_commit_subscription(access_token, subscriptionId):
    ...
    #update subscription after authorization from the customer
    #commit_result = boc_commit_subscription(subscriptionId, authorization_token, current_subscription_data)
    commit_result = boc_commit_subscription(subscriptionId, authorization_token, access_token,current_subscription_data)
    if commit_result.get('status') == 'success':
    ...
    return create_result
################################################################
def boc_change_subscription(access_token, changed_subscriptionId, allow_transactionHistory=True, allow_balance=True, allow_details=True, allow_checkFundsAvailability=True, payments_limit=0, payments_currency='EUR', payments_amount=0):
    ...
    if not subscriptionId:
        error_text=f'subscriptionId NOT returned by boc_get_subscriptionId'
        return api_standard_error_reply(errormsg=error_text)
    ...
    #delete old subs
    delete_result = boc_delete_subscription(access_token, changed_subscriptionId)
    ...
    # else:
    #      create_result = api_standard_fail_reply(errormsg='subscription create failed', return_value=subscriptionId, errors=xcreate_result.get('data'))
    # create_result = boc_create_subscription(access_token, allow_transactionHistory=True, allow_balance=True, allow_details=True, allow_checkFundsAvailability=True, payments_limit=0, payments_currency='EUR', payments_amount=)
    ...
    # #get authorization token from customer authorization code 
    # access_token=boc_get_access_token()#refresh
    # authorization_token=boc_get_authorization_token(access_token,authorization_code)
    # if not authorization_token:
    #     error_text=f'authorization token for authorization code {authorization_code} NOT retrieved'
    #     return api_standard_error_reply(errormsg=error_text)
    ...
    # # commit_result = boc_commit_subscription(subscriptionId, authorization_token, x)
    ...
    # # commit_result = boc_commit_subscription(subscriptionId, authorization_token, changed_subscription_data1)
    ...
    # # #update subscription after authorization from the customer
    # # commit_result = boc_commit_subscription(subscriptionId, authorization_token, subscription_data_string)
    ...
    # #update subscription
    # commit_result = boc_commit_subscription(subscriptionId, authorization_token, changed_subscription_data_json)
...
def boc_delete_subscription(access_token,subscriptionId):
    ...
    #httprequest
    r = boc_standard_http_requestV2(api=api, function='delete', url=api_url,headers=headers, params=params, data=None)
...
################################################################
################################################################
def boc_get_configuration_param(what, configuration, thisbank):
    #global master_configuration
    process = 'boc_get_configuration_param'
...
def boc_get_parameters(api):
    ...
    bankID=boc_get_configuration_param('bankID',master_configuration,bankCodeName)
    log_api_setup_param('bankID',bankID)

    bankName=boc_get_configuration_param('bankName',master_configuration,bankCodeName)
    redirect_uri=boc_get_configuration_param('redirect_uri',master_configuration,bankCodeName)
    app_name=boc_get_configuration_param('application_name',master_configuration,bankCodeName)
    client_id=boc_get_configuration_param('client_id',master_configuration,bankCodeName)
    client_secret=boc_get_configuration_param('client_secret',master_configuration,bankCodeName)
    api_uri=boc_get_configuration_param('api_uri',master_configuration,bankCodeName)
    journeyId=boc_get_configuration_param('journeyId',master_configuration,bankCodeName)
    originSourceId=boc_get_configuration_param('originSourceId',master_configuration,bankCodeName)
    originChannelId=boc_get_configuration_param('originChannelId',master_configuration,bankCodeName)
    originDeptId=boc_get_configuration_param('originDeptId',master_configuration,bankCodeName)
    originUserId=boc_get_configuration_param('originUserId',master_configuration,bankCodeName)
    originEmployeeId=boc_get_configuration_param('originEmployeeId',master_configuration,bankCodeName)
    originTerminalId=boc_get_configuration_param('originTerminalId',master_configuration,bankCodeName)
    correlationId=boc_get_configuration_param('correlationId',master_configuration,bankCodeName)
    lang=boc_get_configuration_param('lang',master_configuration,bankCodeName)
    tppId=boc_get_configuration_param('tppId',master_configuration,bankCodeName)
...
################################################################
def boc_standard_http_request(api='',function='get', url='', headers='', params='', data=''):
    global active_api
    global active_api_prog
    ...
    return r
################################################################
def boc_standard_http_requestV2(api='',function='get', url='', headers='', params='', data=''):
    global active_api
    global active_api_prog
    global active_api_reply
    global active_api_return_OK
...
def boc_get_access_tokenV2():
    ...
    #httprequest
    #r = boc_standard_http_request(api=api, function='post', url=api_url, headers=headers, params=None, data=payload)
    #httprequest
    r = boc_standard_http_requestV2(api=api, function='post', url=api_url,headers=headers, params=None, data=payload)
    if r.get('success'):
...
def boc_get_subscription_details(access_token,subscriptionId):   
    ...
    #httprequest
    r = boc_standard_http_request(url=api_url, function='get', headers=headers, params=params, data=payload)
...
def boc_get_subscription_selectedAccounts(access_token,subscriptionId):   ###even if pending
    ...
    #httprequest
    subscription_accounts = boc_get_subscription_details(access_token, subscriptionId)
...
def boc_get_subscription_Accounts(access_token,subscriptionId):   
    ...
    #httprequest
    subscription_accounts = boc_standard_http_request(api=api, function='get', url=api_url,headers=headers,params=params)
...
def boc_get_subscription_customers(access_token,subscriptionId):   
    ...
    #httprequest
    #subscription_customers = boc_standard_http_request(api=api, function='get', url=api_url,headers=headers,params=params)
    r = boc_standard_http_requestV2(api=api, function='get', url=api_url,headers=headers, params=params, data=None)
    if r.get('success'):
...
def boc_get_subscription_accounts(access_token,subscriptionId):   
    ...
    #httprequest
    r = boc_standard_http_request(api=api, function='get', url=api_url,headers=headers,params=params)
    ...
    return subscription_accounts
################################################################
def boc_get_account_details(access_token, subscriptionId, accountId):
    #start
...
################################################################
def boc_get_account_balances(access_token, subscriptionId, accountId):
    ...
    headers=request_params['headers']
    params=request_params['parameters']
    r = boc_standard_http_request(url=api_url,headers=headers,params=params)
    ...
    return response
################################################################
def boc_get_account_transactions(access_token, subscriptionId, accountId,sdate='',edate='',ntrans=9999):
    ...
    return response
################################################################
def boc_get_account_subscriptions(access_token,accountId):
    ...
    #setup httprequest
    api_params=boc_get_parameters(api)
    request_params=boc_prepare_request_standard(access_token,'',api_params,accountId)
    api_url=request_params['url']
    headers=request_params['headers']
    params=request_params['parameters']

    #httprequest
    r = boc_standard_http_request(api=api, function='get', url=api_url,headers=headers,params=params,data=None)
...
def boc_payment_fundsavailability(access_token,subscriptionId,payment):
    ...
    #r = boc_standard_http_request(url=api_url,headers=headers, params=params, data=paymentData)
    #httprequest
    x= request_params.get('functionRequest')
    r = boc_standard_http_requestV2(api=api, function='post', url=api_url,headers=headers, params=params, data=paymentData)
...
def boc_delete_payment(access_token,subscriptionId,payment_id):
    ...
    r = boc_standard_http_requestV2(api=api, function=request_function, url=api_url, headers=headers, params=params, data=None)
...
### create payment apis                                      ###
################################################################
def boc_get_payment_jws_signature(access_token, subscriptionId, DBaccountId ,CRaccountId,Amount,Currency,Details,endToEndId,terminalId,branch,refNumber,CRaccountBankId,CraccountName,CraccountAddress):
    ...
    #bobbi
    #functionRequest
    r = boc_standard_http_requestV2(api=api,function='post', url=api_url,headers=headers, params=params, data=paymentRequest)
    if r.get('success'):
        # response = r.json()
        # #{
        # #'payload': '...',
...
def boc_payment_create(access_token, subscriptionId, payload):
    ...
    r = boc_standard_http_requestV2(api=api,function=request_function, url=api_url,headers=headers, params=params, data=paymentData)
...
################################################################
def boc_authorize_payment(access_token, subscriptionId, paymentId,authorization_code):
    ...
    r = boc_standard_http_requestV2(api=api, function=request_function, url=api_url, headers=headers, params=params, data=authData)
    if not r.get('success'):
...
################################################################
def boc_make_payment(access_token, subscriptionId, DBaccountId, CRaccountId, Amount, Currency, Details, endToEndId, terminalId, branch, refNumber, CRaccountBankId,CraccountName,CraccountAddress):
    api='make_payment'
    #start
    log_api_start(api)
    ...
    #bobbi    
    fundsavail_Result=boc_payment_fundsavailability(access_token,subscriptionId,payment_request)
    ...
    get_signature_result = boc_get_payment_jws_signature(access_token, subscriptionId, DBaccountId ,CRaccountId,Amount,Currency,Details,endToEndId,terminalId,branch,refNumber,CRaccountBankId,CraccountName,CraccountAddress)
    ...
    create_result=boc_payment_create(access_token, subscriptionId, signature)
    if not create_result.get('status') == 'success':
...
################################################################
def boc_get_subscriptionId(access_token, allow_transactionHistory=True, allow_balance=True, allow_details=True, allow_checkFundsAvailability=True, payments_limit=0, payments_currency='EUR', payments_amount=0):
    global http_request
    ...
    #httprequest
    r = boc_standard_http_requestV2(api=api, function='post', url=api_url,headers=headers, params=params, data=subscription_data_string)
    if r.get('success'):
    ...
    return create_result
################################################################
def boc_xget_subscriptionId(access_token,SubscriptionRequest):   
    ...
    #httprequest
    r = boc_standard_http_request(api=api, function='post', url=api_url,headers=headers, params=params, data=SubscriptionRequest)
...
################################################################
def boc_get_customer_authorization(access_token,subscriptionId):
    global master_configuration
    ...
    res = boc_get_customer_Consent(subscriptionId)
...
################################################################
################################################################
def boc_commit_subscription(subscriptionId,authorization_token,access_token,subscription_data):   
    ...
    params.update({'subscriptionId': subscriptionId})    
    headers=request_params['headers']
    data=current_subscription_data

    #httprequest
    r = boc_standard_http_requestV2(api=api, function='patch', url=api_url,headers=headers,params=params,data=current_subscription_data)
...
### _utilities                                                ###
################################################################
def boc_clear_pending_subscriptions(accounts):
    ...
    for accountId in accounts:
        ...
        subscriptions=boc_get_account_subscriptions(access_token,accountId)
        if subscriptions:
            n=0
    ...
    return msg
################################################################
def boc_clear_all_subscriptions(accounts):
    ...
    return msg
################################################################
def boc_get_customer_subscriptions(accounts,resultoption=''):
    ...
    return customer_subscriptions
################################################################
def boc_check_subscription(subscriptionId):
    ...
    subscription = boc_get_subscription_details(access_token, subscriptionId)
