...
def log_module_initialization_message(module_identityDictionary):
    if thisApp.DEBUG_ON and thisApp.CONSOLE_ON:
...
#::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
#############################################################################
def retrieve_module_configuration(module_file, module_identityDictionary, module_configuration={}, print_enabled=None, filelog_enabled=None):
    ...
    module_is_externally_configurable=module_identityDictionary.get('module_is_externally_configurable',False)
    if not module_id:
        module_id = module_name
    if module_name == '__init__':
        module_name = module_id

    # print(module_name,module_folder)
    # print(module_name,'from _logServices')
