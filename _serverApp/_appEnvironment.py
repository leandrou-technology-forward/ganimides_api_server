...
client_id = ''
client_secretKey = ''
machine_id = str(uuid.uuid4()) #subprocess.check_output('wmic csproduct get uuid').decode().split('\n')[1].strip()
...
application_configuration.update({'DEBUG_ON': CONSOLE_ON})
...
#new for local v3
GOOGLE_RECAPTCHA_SITE_KEY = "6LeNEb4UAAAAAN29o3PtUl8alFZHXeE1gTiLJOVg"
GOOGLE_RECAPTCHA_SECRET_KEY = "6LeNEb4UAAAAAD5Z7Adq7563vJUhXYRCANwEimPY"
...
def pair_application_configuration(paired_appl_configuration,paired_appl_identityDictionary):
    ...
    if application_name and paired_module_name: #and applicationID and application_title and
        ...
        msg = f'   {Fore.RED}o{Fore.RESET} {module_color}thisApp{Fore.LIGHTBLACK_EX}: application paired with {application_Color}{paired_module_name}{Fore.RESET}{Back.RESET}'
        if DEBUG_ON:
            print(msg)
    else:
        msg = f'   {Fore.RED}o{Fore.RESET} {module_color}thisApp{Fore.LIGHTBLACK_EX}: application {Fore.RED}FAILED to paired{Fore.LIGHTBLACK_EX} with {application_Color}{paired_module_name}{Fore.RESET}{Back.RESET}'
        if DEBUG_ON:
            print(msg)
    ...
    if DEBUG_ON:
        msg=f'   {Fore.RED}o{Fore.LIGHTBLACK_EX} {Fore.YELLOW}thisApp{Fore.LIGHTBLACK_EX}: client_id set to {Fore.CYAN}{client_id}{Fore.RESET}'
        print(msg)
        secretKeyStr=client_secretKey[0:20]+'...'
        msg=f'   {Fore.RED}o{Fore.LIGHTBLACK_EX} {Fore.YELLOW}thisApp{Fore.LIGHTBLACK_EX}: client_secretKey set to {Fore.CYAN}{secretKeyStr}{Fore.RESET}'
        print(msg)
        msg=f'   {Fore.RED}o{Fore.LIGHTBLACK_EX} {Fore.YELLOW}thisApp{Fore.LIGHTBLACK_EX}: device_uid set to {Fore.CYAN}{device_uid}{Fore.RESET}'
        print(msg)
        ...
        if k.upper()==what.upper():
            ...
            if inspect.isfunction(v):
                ...
                try:
                    ...
                    pass
#############################################################################
def get_module_debug_levelV1(module_id):
    ...
    app_debug_level = get_debug_option_as_level(application_configuration.get('DEBUG_ON'))
    print(module_id,module_debug_level,app_debug_level)
    return max(module_debug_level, app_debug_level)
    # flder = application_configuration.get('modules_loaded', {}).get(module_id)
    # if flder:
    #     parent_folder = os.path.dirname(flder)
    #     parent_module = application_configuration.application_configuration.get('modules', {}).get(parent_folder)
    #     print (parent_module)
#############################################################################
def get_module_debug_level(module_id):
    ...
    if flder:
        ...
        while parent_module:
            ...
            parent_module = application_configuration.get('modules', {}).get(parent_folder)
            if parent_module:
                # print (ix,parent_module)
                config_key=parent_module+'_debug'
                module_debug = application_configuration.get(config_key, None)
                module_debug_level = get_debug_option_as_level(module_debug)
                parent_debug_level = max(module_debug_level, parent_debug_level)
    # print(module_id,module_debug_level,app_debug_level,parent_debug_level)
    return max(module_debug_level, app_debug_level,parent_debug_level)
#############################################################################
#::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
...
if DEBUG_ON and CONSOLE_ON:
    print(msg)
#print(DEBUG_ON,CONSOLE_ON)
#::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
#::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
#::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
# main (for testing)
